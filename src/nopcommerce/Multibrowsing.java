...
public class Multibrowsing {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.className("ico-login")).click(); //Click on Login url
        WebElement emailFiled = driver.findElement(By.id("Email")); //stroing emailfield
        emailFiled.sendKeys("maitrypatel168@gmail.com");//sendkeys to emailfield
